...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Registrar Local</p>
    ...
    <form>
      ...
      <div class="form-group has-feedback">
        <input type="number" class="form-control" placeholder="codigo" id="codigo" name="codigo">

      </div>
      <div class="form-group has-feedback">
        <input type="number" class="form-control" placeholder="ubigeo" id="ubigeo" name="ubigeo">
...
<script src="jquery-3.4.1.min.js"></script>    
        <script>             
            ...
            $("#registrar").click(function() {
                ...
                user.direccion = $('#direccion').val();
                user.codigo = $('#codigo').val();
                user.ubigeo = $('#ubigeo').val();
                console.log(user);
                $.ajax({
                        url: "LocalRegister",
                        type: 'POST',
