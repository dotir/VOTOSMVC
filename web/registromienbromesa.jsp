...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Registrar Mienbros de Mesa</p>

    <form>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="id_persona" id="id_persona">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="id_mesa" id="id_mesa">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
...
<script src="jquery-3.4.1.min.js"></script>    
        <script>             
            ...
            $("#registrar").click(function() {
                var user = new Object();
                user.id_persona = $('#id_persona').val();
                user.tipo = $('#tipo').val();
                user.descripcion = $('#descripcion').val();
                user.id_mesa = $('#id_mesa').val();
                console.log(user);
                $.ajax({
                        url: "MienbroMesaRegister",
                        type: 'POST',
                        dataType: 'json',
                        data: {
